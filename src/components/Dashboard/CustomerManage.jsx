    ...
    <>
      <div className='container'>
        <form onSubmit={handleRegister}>
          ...
          <div className="form-floating mb-2">
            <input maxLength="40" value={location.lat} className="form-control" id="floatingInput" placeholder="latitude" onChange={(e) => setLocation({ lat: e.target.value })} />
            <label htmlFor="floatingInput">lattitude</label>
          </div>
          <div className="form-floating mb-2">
            <input maxLength="40" value={location.lng} className="form-control" id="floatingInput" placeholder="Longitude" onChange={(e) => setLocation({ lng: e.target.value })} />
